...
#ifndef SEGUES_SWIFT_H
#define SEGUES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Segues",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Segues11AppDelegate")
...
SWIFT_CLASS("_TtC6Segues13SceneDelegate")
...
SWIFT_CLASS("_TtC6Segues20SecondViewController")
@interface SecondViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Nullable outputLabel;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6Segues14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Nullable inputTextField;
- (void)viewDidLoad;
